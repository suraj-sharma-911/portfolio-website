...
import profilePic from "@/public/profiePic.png";
    ...
    >
      ...
      >
        ...
        <a
          ...
          href="/SurajKumarSharmaResume.pdf"
          download
        >
          Download CV{" "}
        ...
        <a
          className="bg-white p-4 flex text-gray-700 items-center gap-2 
        rounded-full focus:scale-[1.15] hover:scale-[1.15]
        active:scale-105 transition cursor-pointer hover:text-gray-950
        border border-black/10 dark:bg-white/10 dark:text-gray-50 dark:text-opacity-60"
          href="https://www.linkedin.com/in/suraj-kumar-sharma/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        active:scale-105 transition cursor-pointer hover:text-gray-950 
        border border-black/10 dark:bg-white/10 dark:text-gray-50 dark:text-opacity-60"
          href="https://github.com/suraj-sharma-911"
          target="_blank"
        >
          <BsGithub />
        </a>
